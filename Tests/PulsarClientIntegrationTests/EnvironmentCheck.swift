...
struct EnvironmentCheck {
    ...
    func testEnvironment() async throws {
        let serviceURL = ProcessInfo.processInfo.environment["PULSAR_SERVICE_URL"] ?? "pulsar://localhost:6650"
        let adminURL = ProcessInfo.processInfo.environment["PULSAR_ADMIN_URL"] ?? "http://localhost:8080"
