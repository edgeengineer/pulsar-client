...
struct AuthenticationIntegrationTests {
    ...
    init() {
        self.serviceUrl = ProcessInfo.processInfo.environment["PULSAR_SERVICE_URL"] ?? "pulsar://localhost:6650"
        self.adminUrl = ProcessInfo.processInfo.environment["PULSAR_ADMIN_URL"] ?? "http://localhost:8080"
    }
