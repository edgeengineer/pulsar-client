...
extension Schema where T == Data {
  /// Bytes schema (no serialization)
  public static var bytes: Schema<Data> {
    Schema<Data>(
...
extension Schema where T == String {
  /// String schema (UTF-8)
  public static var string: Schema<String> {
    Schema<String>(
...
extension Schema {
  /// JSON schema for Codable types
  public static func json<U: Codable>(_ type: U.Type) -> Schema<U> {
