...
extension PulsarClientProtocol {

  /// Create a producer with default byte array schema
  public func newProducer(topic: String) async throws -> any ProducerProtocol<Data> {
  ...
  public func newConsumer(topic: String, subscription: String) async throws -> any ConsumerProtocol<
    Data
  > {
  ...
  public func newReader(topic: String, startMessageId: MessageId = .earliest) async throws
    -> any ReaderProtocol<Data>
  {
  ...
  public func newStringProducer(topic: String) async throws -> any ProducerProtocol<String> {
    return try await newProducer(
      topic: topic,
  ...
  public func newStringConsumer(topic: String, subscription: String) async throws
    -> any ConsumerProtocol<String>
  {
    return try await newConsumer(
      topic: topic,
      schema: Schema<String>.string
  ...
  public func newStringReader(topic: String, startMessageId: MessageId = .earliest) async throws
    -> any ReaderProtocol<String>
  {
    return try await newReader(
      topic: topic,
      schema: Schema<String>.string
...
extension PulsarClientProtocol {
  ...
  public func newConsumer<T>(
    ...
    return try await newConsumer(
      ...
      let options = ConsumerOptions(
        subscriptionName: subscriptionName, topics: topics, schema: schema)
  ...
  public func newConsumer<T>(
    ...
    return try await newConsumer(
      ...
      let options = ConsumerOptions(
        subscriptionName: subscriptionName, topicsPattern: topicsPattern, schema: schema)
      builder.options = options
