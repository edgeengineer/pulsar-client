...
public enum AuthenticationFactory {
  ...
  /// - Returns: A token authentication instance
  public static func token(supplier tokenSupplier: @escaping @Sendable () async throws -> String)
    -> Authentication
  {
...
extension AuthenticationFactory {
  ...
  /// - Returns: A token authentication instance
  public static func tokenFromFile(_ filePath: String) -> Authentication {
    return token {
      do {
  ...
  /// - Returns: A token authentication instance
  public static func tokenFromEnvironment(_ variableName: String) -> Authentication {
    return token {
  ...
  /// - Returns: An OAuth2 authentication instance
  public static func oauth2FromFile(_ filePath: String) throws -> Authentication {
  ...
  public static func tlsFromFiles(certificatePath: String, privateKeyPath: String) throws
    -> Authentication
  {
